...
def github():
    ...
    LSTM_API_URL = "https://lstm-forecast-2vt6wiguka-uc.a.run.app/" + "api/forecast"
    ...
    repo_list = ["golang/go","google/go-github","angular/material","angular/angular-cli","sebholstein/angular-google-maps","d3/d3","facebook/react","tensorflow/tensorflow","keras-team/keras","pallets/flask"]   
    dic = {}    
    ...
    stargazers_count = []   
    for key in dic.keys():  
        array = [str(key), dic[key]]    
        stargazers_count.append (array) 
    ...
    json_response = {
        ...
        "closed_week": closed_at_issues_week,
